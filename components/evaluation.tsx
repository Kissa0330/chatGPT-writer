...
const App = (props: Prop) => {
	...
	async function submitGPT() {
		...
		{
			content += "Please rate the consistency of the following sentences on a 100-point scale. Please output the score and the rating. Please output only numbers for the score.\n\""
		}
		content += props.text;
		content += "\""
